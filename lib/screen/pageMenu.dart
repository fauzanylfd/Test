...
import 'package:gopet/component/doctorModel.dart';
import 'package:gopet/screen/foodPage.dart';
...
@override
GestureDetector _serviceItem(int index, int selectedService) {
  return GestureDetector(
    onTap: () {
      // Implementasi navigasi ke halaman lain sesuai kebutuhan
      Navigator.push(
        context,
