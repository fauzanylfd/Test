...
class FoodPage extends StatefulWidget{
  ...
  @override
  State<FoodPage> createState() => _pageMenuState();
}

class _pageMenuState extends State<FoodPage> {
  @override
...
ListView _food() {
    return ListView.separated(
        ...
        shrinkWrap: true,
        itemBuilder: (context, index) => _foods(foods[index]),
        separatorBuilder: (context, index) => const SizedBox(
              height: 11,
            ),
        itemCount: foods.length);
  }
Container _foods(foodModel doctorModel) {
    return Container(
